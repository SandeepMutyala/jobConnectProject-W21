...
const EditJobPost= () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:4000/jobpost/displayjobpost/"+ location.state)
      .then((response) => {
  ...
  const handleReSubmit = e => {
    ...
    axios.put("http://localhost:4000/jobpost/updatejobpost/"+ location.state, updateForm)
  ...
  const handleDelete = e =>{ 
    ...
    axios.delete("/jobpost/deletejobpost/"+location.state )
      .then(res=>console.log(res))
                  ...
                  <Form.Label id='label' column sm={5}>Country:</Form.Label>
                    <Col sm={3}>
                      <Form.Control 
                        id='place-holder'
                        as='select' 
                        onChange={ e => setFormField('country', e.target.value) } value={editForm? editForm.country : null}
                      >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('language', e.target.value) } value={editForm ? editForm.language : null}
                    >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('companyName', e.target.value) } value={editForm? editForm.companyName:null} 
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('jobTitle', e.target.value) } value={editForm ? editForm.jobTitle : null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('jobShortDescription', e.target.value) } value={editForm ? editForm.jobShortDescription: null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('workLocation', e.target.value) } value={editForm ? editForm.workLocation : null}
                    >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('addLocation', e.target.value) } value={editForm ? editForm.addLocation : null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='number' 
                      onChange={ e => setFormField('hiringCount', e.target.value) } value={editForm ? editForm.hiringCount: null}
                      />
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('lastDateToApply', e.target.value) } value={editForm ? editForm.lastDateToApply: null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('jobType1', e.target.value) } value={editForm ? editForm.jobType1: null}
                    >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('jobType2', e.target.value) } value={editForm ? editForm.jobType2: null}
                    >
                      <option value=''>Select the job type</option>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('schedule', e.target.value) } value={editForm ? editForm.schedule: null}
                    >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      id='place-holder'
                      as='select' 
                      onChange={ e => setFormField('payType', e.target.value) } value={editForm ? editForm.payType: null}
                    >
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      placeholder='Pay'
                      type='number' 
                      onChange={ e => setFormField('pay', e.target.value) } value={editForm ? editForm.pay:null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      as='textarea' 
                      onChange={ e => setFormField('jobDescription', e.target.value) } value={editForm ? editForm.jobDescription: null}
                    />
                  </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                  ...
                  <Col sm={3}>
                    <Form.Control 
                      ...
                      type='text' 
                      onChange={ e => setFormField('companyLogoUrl', e.target.value) } value={editForm ? editForm.companyLogoUrl: null}
                    />
                  </Col>
                </Form.Group>
